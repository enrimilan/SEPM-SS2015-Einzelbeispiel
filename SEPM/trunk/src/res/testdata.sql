...
INSERT INTO RaceResult(race_id,horse_id,jockey_id,horse_name,jockey_name,random_speed,luck_factor,jockey_skill_calc,average_speed,rank) VALUES (1,1,3,'Jacky','Stevie Cauthen',61.16,1.03,0.98,61.73,4);
INSERT INTO RaceResult(race_id,horse_id,jockey_id,horse_name,jockey_name,random_speed,luck_factor,jockey_skill_calc,average_speed,rank) VALUES (1,3,5,'Manchego','Alan Garcia',56.49,1.02,1.04,59.92,5);
INSERT INTO RaceResult(race_id,horse_id,jockey_id,horse_name,jockey_name,random_speed,luck_factor,jockey_skill_calc,average_speed,rank) VALUES (1,5,7,'Dark Sparks','Kirsty Milczarek',92.67,0.99,1.05,96.33,1);
INSERT INTO RaceResult(race_id,horse_id,jockey_id,horse_name,jockey_name,random_speed,luck_factor,jockey_skill_calc,average_speed,rank) VALUES (1,7,9,'Sweet Ranger','Lance Sullivan',64.68,0.99,1.02,65.31,3);
INSERT INTO RaceResult(race_id,horse_id,jockey_id,horse_name,jockey_name,random_speed,luck_factor,jockey_skill_calc,average_speed,rank) VALUES (1,9,1,'Sherman','Eddie Ahern',65.93,0.97,1.03,65.87,2);
INSERT INTO RaceResult(race_id,horse_id,jockey_id,horse_name,jockey_name,random_speed,luck_factor,jockey_skill_calc,average_speed,rank) VALUES (2,2,4,'Avenida','Patricia Cooksey',74.06,1.03,1.03,78.57,3);
INSERT INTO RaceResult(race_id,horse_id,jockey_id,horse_name,jockey_name,random_speed,luck_factor,jockey_skill_calc,average_speed,rank) VALUES (2,4,6,'Trixie','Julien Leparoux',62.17,0.97,0.95,57.29,4);
INSERT INTO RaceResult(race_id,horse_id,jockey_id,horse_name,jockey_name,random_speed,luck_factor,jockey_skill_calc,average_speed,rank) VALUES (2,6,8,'Penny','Anna Napravnik',79.7,1.0,1.05,83.69,2);
INSERT INTO RaceResult(race_id,horse_id,jockey_id,horse_name,jockey_name,random_speed,luck_factor,jockey_skill_calc,average_speed,rank) VALUES (2,10,2,'Swiftbolt','Robby Albarado',94.32,1.04,1.01,99.07,1);
INSERT INTO RaceResult(race_id,horse_id,jockey_id,horse_name,jockey_name,random_speed,luck_factor,jockey_skill_calc,average_speed,rank) VALUES (2,1,1,'Jacky','Eddie Ahern',58.17,0.95,1.03,56.92,5);