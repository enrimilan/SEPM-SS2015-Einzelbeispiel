...
public class JDBCRaceResultDAOTest extends AbstractRaceResultDAOTest {
    ...
    public void setUp() throws DAOException, SQLException {
        ...
        RaceResult raceResult1 = new RaceResult(5,1,1,"Jacky","Eddie Ahern",60.0,0.95,2.48,241.36,2);
        RaceResult raceResult2 = new RaceResult(5,2,2,"Avenida","Robby Albarado",70.0,1.05,1.54,131.19,4);
        RaceResult raceResult3 = new RaceResult(5,3,3,"Manchego","Steve Cauthen",77.0,1.00,-0.04,-3.08,5);
